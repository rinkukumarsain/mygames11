        ...
        matchChallengersModel.aggregate(condition).exec((err, rows1) => {
          rows1.forEach(async (doc) => {
            ...
            data.push({
              ...
              action: `${doc.joinedusers != 0
                ? `<div class="text-center"><a href="/contest-user-details/${doc.matchkey}?challengeid=${doc._id}" class="btn btn-sm btn-primary w-35px h-35px" data-toggle="tooltip" title="View Users" data-original-title="View User" aria-describedby="tooltip768867"><i class="fas fa-eye"></i></a></div>`
