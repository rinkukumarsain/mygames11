        ...
        try {
            ...
            for await (const matchchallenge of matchchallengesData) {
                ...
                finalData.push({
                    ...
                    image: matchchallenge.contest_cat ? `${process.env.BASE_URL}${matchchallenge.contestcategories[0].image}` : `${process.env.BASE_URL}logo.png`,
        ...
        try {
                ...
                $addFields: {
                    ...
                    image: {
                        $cond: {
                            ...
                            // else: `${process.env.BASE_URL}user.png`,
                        },
                    },
                },
            });
            ...
            aggPipe.push({
                $project: {
                    ...
                    image: { $ifNull: ['$image', `${process.env.BASE_URL}user.png`] },
